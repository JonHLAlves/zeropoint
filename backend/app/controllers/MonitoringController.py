...
if not os.getenv('TRUENAS_BASE_URL') or not os.getenv('TRUENAS_API_KEY'):
    raise RuntimeError("As variáveis de ambiente TRUENAS_BASE_URL e TRUENAS_API_KEY devem ser definidas.")
